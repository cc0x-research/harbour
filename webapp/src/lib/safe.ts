...
async function getSafeConfiguration(
	...
	const calls = [
		{ target: safeAddress, callData: SAFE_INTERFACE.encodeFunctionData("getOwners") },
		{ target: safeAddress, callData: SAFE_INTERFACE.encodeFunctionData("getThreshold") },
		{ target: safeAddress, callData: SAFE_INTERFACE.encodeFunctionData("getStorageAt", [FALLBACK_SLOT, 1]) },
		{ target: safeAddress, callData: SAFE_INTERFACE.encodeFunctionData("nonce") },
		{ target: safeAddress, callData: SAFE_INTERFACE.encodeFunctionData("getStorageAt", [GUARD_SLOT, 1]) },
		{ target: safeAddress, callData: SAFE_INTERFACE.encodeFunctionData("getStorageAt", [SINGLETON_SLOT, 1]) },
		{
			target: safeAddress,
